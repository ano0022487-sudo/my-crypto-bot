...
class Collector{
 constructor(ws){
  ...
  this.tradeQueue=[];this.tickerQueue=[];this.candleQueue=[];this.oiQueue=[];this.oiLatest=new Map();this.fundingQueue=[];this.fundingLatest=new Map();this.flushInProgress=false;this.flushBlockedUntil=0;this.flushFailures=0;this.lastFlushAt=null;this.lastDbErrorAt=null;this.droppedTrades=0;this.droppedTickers=0;this.droppedCandles=0;this.droppedOI=0;this.droppedFunding=0;this.eventsReceived=0;this.lastDbErrorLogAt=0;
