...
CREATE INDEX IF NOT EXISTS ticker_snapshots_ts_idx ON ticker_snapshots(ts);
...
CREATE INDEX IF NOT EXISTS candles_retention_ts_idx ON candles(ts);
...
CREATE INDEX IF NOT EXISTS orderbook_ts_idx ON orderbook_snapshots(ts);
...
CREATE INDEX IF NOT EXISTS oi_ts_idx ON open_interest_snapshots(ts);
...
CREATE INDEX IF NOT EXISTS funding_ts_idx ON funding_snapshots(ts);
...
CREATE INDEX IF NOT EXISTS funding_history_time_idx ON funding_history(funding_time);
...
CREATE INDEX IF NOT EXISTS liquidation_ts_idx ON liquidation_events(ts);
...
CREATE INDEX IF NOT EXISTS anomalies_ts_idx ON market_anomalies(ts);
